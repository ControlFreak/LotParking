...
class ParkingLot < Base
  ...
  def leave slot
    ...
    puts INVALID_SLOT_MESSAGE; return if slot > slots.length || slot == 0
    slots[slot-1].unpark
  ...
  def registration_numbers_for_cars_with_colour color
    ...
    puts NO_CAR_FOUND_MESSAGE; return unless cars
    puts cars.join(", ")
  end
